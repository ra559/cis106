...
## What You Will Learn
The goal of this extra credit is to help you become familiar with using Debian and the GNOME Desktop Environment. 
The screenshots in this document were taken in Ubuntu 24.04. However, the GNOME interface is very similar in Debian, so you should still be able to follow along. If you notice any major differences or inconsistencies, please let me know.
...
* 2- Use Firefox or another web browser to download the following ZIP file: [https://cis106.com/assets/extras/gcu/site.zip](/assets/extras/gcu/site.zip)
...
* 6- Use the website [Pexels.com](https://www.pexels.com/) to download 3 Landscape format images. 
