...
## Video/Resources
* [Video here](#)
* [Presentation](https://rapurl.live/csv)
...
2. Explain how to use the pipe (`|`) for redirecting the output of a command to another. Include at least 3 examples
3. Explain how to save the output of a command to a file (`>`). Include at least 3 examples
4. Explain how to append the output of a command to a file. Include at least 3 examples
